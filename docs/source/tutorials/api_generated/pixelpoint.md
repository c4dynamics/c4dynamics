...
`pixelpoint` is a data structure for managing
...
datasets module (see `c4dynamics.datasets`):
...
### Returns
out : numpy.int32
  A numpy array of the normalized coordinates $[x, y, v_x, v_y]$ transformed
...
### Examples
For detailed usage,
see the examples in the introduction to the `pixelpoint` class.
